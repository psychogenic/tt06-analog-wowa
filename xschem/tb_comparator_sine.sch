...
C {devices/lab_pin.sym} -80 -210 0 0 {name=p17 lab=VSS}
C {devices/vsource.sym} -80 -260 0 0 {name=V2 value="sin VTHRESH INAMP 1MEG 800n" savecurrent=false}
C {devices/lab_pin.sym} -80 -400 2 0 {name=p18 lab=PLUS}
C {devices/res.sym} -80 -330 0 0 {name=R1
value=1k
footprint=1206
device=resistor
m=1}
C {devices/lab_pin.sym} -80 -460 2 0 {name=p15 lab=PLUS}
C {devices/res.sym} -120 -460 1 0 {name=R2
value=1k
footprint=1206
device=resistor
m=1}
C {devices/lab_pin.sym} -190 -460 0 0 {name=p16 lab=CALIBTHRESH}
