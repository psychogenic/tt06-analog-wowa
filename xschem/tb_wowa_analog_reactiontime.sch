...
cal"}
B 2 -1460 -210 -720 170 {flags=graph
y1=-0.034
y2=1.9
ypos1=0
ypos2=2
...
C {sky130_fd_pr/corner.sym} -1870 90 0 0 {name=CORNER only_toplevel=true corner=tt_mm}
C {devices/code.sym} -1870 -90 0 0 {name=stimuli only_toplevel=false value="
...
descr="load waves" 
tclcommand="xschem raw_read $netlist_dir/tb_wowa_analog_reactiontime.raw tran"
}
